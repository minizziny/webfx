...
import org.araqne.api.PrimitiveConverter.SerializeOption;
...
public class FileUploadPlugin {
	...
	public void setUploadToken(Request req, Response resp) {
		...
		final String template = "araqne dom: set upload info, session [{}], token [{}], space [{}], filename [{}], size [{}]";
	...
	public void removeDownloadTokens(Session session) {
		...
		logger.trace("araqne dom: clearing download token for session {}", session.getGuid());
