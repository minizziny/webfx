require(["/lib/jquery.js",
	...
	Socket.send("org.araqne.dom.msgbus.AreaPlugin.getRootAreas", {}, function(message) {
		console.log(message)
	...
	$("#btnAddNewArea").on("click", function(e) {
		...
		Socket.send("org.araqne.dom.msgbus.AreaPlugin.createArea", newarea, function(message) {
			console.log(message)
	...
	$("#btnRemoveArea").on("click", function() {
		...
		Socket.send("org.araqne.dom.msgbus.AreaPlugin.removeArea", {
