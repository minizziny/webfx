...
.value('en-us', {
	...
	'$S_str_Done': '완료',
	'$S_msg_TotalUserCount': '총 {0}명의 사용자',
	'$S_msg_TotalUsersCount': '총 {0}명의 사용자',
	'$S_msg_SearchedUserCount': '{0}명 검색됨',
	'$S_msg_SearchedUsersCount': '{0}명 검색됨',
	'$S_msg_SelectedUserCount': '{0}명 선택됨',
	'$S_msg_SelectedUsersCount': '{0}명 선택됨',
