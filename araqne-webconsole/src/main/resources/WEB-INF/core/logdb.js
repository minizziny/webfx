...
var Query = function(jobj) {
	...
	this.stop = function(callback) {
		...
		socket.send("org.araqne.logdb.msgbus.LogQueryPlugin.stopQuery", { "id": that.activeId() }, function(m) {
			if(!!callback) {
				callback();
			}
		});
...
var logdbManager = (function() {
	...
	function getQueries(callback) {
		socket.send("org.araqne.logdb.msgbus.LogQueryPlugin.queries", {}, function(m) {
			if(m.isError) {
