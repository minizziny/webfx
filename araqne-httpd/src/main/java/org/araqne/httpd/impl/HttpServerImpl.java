...
import org.araqne.httpd.HttpConfigurationListener;
...
public class HttpServerImpl implements HttpServer, HttpConfigurationListener {
	...
	public void addVirtualHost(VirtualHost vhost) {
		if (vhost.getHttpContextName() == null)
			throw new IllegalArgumentException("araqne httpd: http context name shoud not null");
	...
	private void saveConfig() {
		...
		if (c != null) {
			...
			logger.error("araqne httpd: cannot find configuration for " + config.getListenAddress());
		}
	}
