...
public class HttpdScript implements Script {
	...
	public void open(String[] args) {
		try {
			...
			logger.error("araqne webconsole: cannot open port", e);
		}
	}
	...
	public void openSsl(String[] args) {
		try {
			...
			context.println(e.getMessage());
			logger.error("araqne webconsole: cannot open ssl port");
		}
	}
	...
	public void close(String[] args) {
		try {
			...
			context.println(e.getMessage());
			logger.error("araqne webconsole: cannot close port", e);
		}
	}
	...
	public void attachDirectory(String[] args) {
		...
		try {
			...
			logger.error("araqne httpd: cannot attach filesystem path", t);
		}
	}
