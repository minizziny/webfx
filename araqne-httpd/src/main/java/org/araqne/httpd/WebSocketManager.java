...
public class WebSocketManager {
	...
	public void register(WebSocket socket) {
		logger.trace("araqne httpd: adding websocket session [{}]", socket);
		...
		for (WebSocketListener listener : listeners) {
			try {
				...
				logger.warn("araqne httpd: callback should not throw any exception", e);
			}
		}
	}
	...
	public void unregister(InetSocketAddress remote) {
		...
		logger.trace("araqne httpd: removing websocket session [{}]", remote);
	...
	public void dispatch(WebSocketFrame frame) {
		...
		if (socket == null) {
			logger.warn("araqne httpd: websocket not found for frame [{}]", frame);
			return;
		}

		logger.trace("araqne httpd: received frame [{}]", frame);
	...
	public void addListener(WebSocketListener listener) {
		logger.trace("araqne httpd: listener [{}] added", listener);
		listeners.add(listener);
	}

	public void removeListener(WebSocketListener listener) {
		logger.trace("araqne httpd: listener [{}] removed", listener);
